...
@torch.no_grad()
def auto_scale_block_bit_adjust_per_linear(module, module_kwargs, w_bit, q_config, input_feat, module_bit = None):
    ...
    def _search_module_scale_per_linear(block, linears2scale: dict, x, kwargs={}, module_bit=None):
        ...
        # module_bit = {proj : arch['arch'][proj][i] for proj in ['self_attn.q_proj', 'self_attn.k_proj', 'self_attn.v_proj', 'self_attn.o_proj', 'mlp.up_proj', 'mlp.gate_proj', 'mlp.down_proj']}
